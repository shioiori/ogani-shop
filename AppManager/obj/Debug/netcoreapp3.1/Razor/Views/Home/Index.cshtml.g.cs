#pragma checksum "F:\Backend Devmaster\AppManager\AppManager\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "121c5a761e1419d9a1bfb19fe4698dc4ad87137c"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"121c5a761e1419d9a1bfb19fe4698dc4ad87137c", @"/Views/Home/Index.cshtml")]
        ...
        <div class=""row"">
            ...
            <div class=""col-lg-4 col-md-6"">
                <div class=""latest-product__text"">
                    ...
                    <div cl");
            WriteLiteral(@"ass=""latest-product__slider owl-carousel"" id=""review-product"">
                    </div>
                </div>
            </div>
        </div>
     ...
     ");
                                    ...
                                    <div class=""featured__item"">
                                        <div class=""featured__item__pic set-bg"" style=""background-image: url(${itm.avatar})"">
                                            <ul class=""featured__item__pic__hover"" id=""${itm.id}"">
                                                ...
                                                <li><a href");
                WriteLiteral(@"=""#"" class=""add-to-cart""><i class=""fa fa-shopping-cart""></i></a></li>
                                            </ul>
                                        </div>
                                        <div class=""featured__item__text"">
                                            <h6><a href=""/ProductDetail/Product?id=${itm.id}"">${itm.name}</a></h6>
                                            <h5>$${price}</h5>
                                        </div>
                                    </div>
                                </div>`
        ...
        $(document).ready(function(){
            $(document).on('click', '.add-to-cart', function(e){
                ...
                $.ajax({
                    url: ""/Shopping");
                WriteLiteral(@"Cart/AddItemToCart"",
                    type: ""GET"",
                    data: {
                        id: id,
                    },
            ...
            success: function(data){
               ...
               data.forEach(function(item,index){
                   let row = `<div class=""col-lg-6 col-md-6 col-sm-6"">
                                    <div class=""banner__pic"">
                          ");
                WriteLiteral(@"              <img src=""${item.imagePath}"" alt="""">
                                    </div>
                               </div>`;
        ...
        $.ajax({
            ...
            success: function(data){
                let co");
                WriteLiteral(@"l = jQuery('<div>', {class: 'latest-prdouct__slider__item' });
                data.forEach(function(item,index){
                    ...
                    if (index % 3 == 2){
                       ...
                       // $('#toprate-product').owlCarousel().trigger(");
                WriteLiteral(@"'add.owl.carousel', col);                    
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                data.forEach(function(item,index){
                    let price = parseFloat(item.price).toFixed(2);
                    let row = `<a href=""/ProductDetail/Product?id=${item.id}"" class=""latest-pro");
                WriteLiteral(@"duct__item"">
                                    <div class=""latest-product__item__pic"">
                                        <img src=""${item.avatar}"" alt="""">
                                    </div>
                                    <div class=""latest-product__item__text"">
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                data.forEach(function(item,index){
                    ...
                    if (index % 3 == 2){                  
                        $('#review-product')");
                WriteLiteral(@".owlCarousel().trigger('add.owl.carousel', col);                    
                        col = jQuery('<div>', {class: 'latest-prdouct__slider__item' });
                    }
                });
                $('#review-product').trigger('refresh.owl.carousel');
